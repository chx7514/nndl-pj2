...
from utils.nn import get_vgg_weights, set_vgg_weights
...
def train(model, optimizer, criterion, train_loader, val_loader, scheduler=None, epochs_n=100, best_model_path=None):
    ...
    for epoch in range(epochs_n):
        ...
        for data in train_loader:
            ...
            # save the weights initial gradient
            if i % 30 == 0:
            ...
            if i % 30 == 0:
                ...
                distances.append(torch.norm(new_grad - init_grad, 2))
                iterations.append(i)
...
def plot_loss_landscape(iteration,VGG_A_max_curve,
    ...
    plt.savefig('Gradient_Predictiveness.png')
...
plot_loss_landscape(iterations, VGG_A_max,
                    VGG_A_min, VGG_A_BN_max,
                    VGG_A_BN_min)
